    ...
    return (
        <div style={{minHeight: '100vh', paddingTop: '50px'}}>
            ...
            <Grid container style={{position: 'relative', paddingTop: '50px'}}>
                ...
                <Grid item xs={12} md={12} style={{padding: '20px', paddingTop: '30px', paddingBottom: '50px'}}>
                    <Slide up>
                    ...
                    <Grid container style={{padding: '10px'}}>
                        <Grid item xs={12} md={3} style={{padding: '10px'}}>
                            ...
                            <div style={{textDecoration: 'underline', paddingBottom: '5px', color: '#FFF'}}>The Rug <Arrow /></div>
                        </Grid>
                        <Grid item xs={12} md={4} style={{padding: '10px'}}>
                            <div style={{display: 'flex'}}>
                            <img src={process.env.PUBLIC_URL + '/assets/media/icon_mirror.webp'} alt="mirror" style={{padding: '10px', borderRadius: '10px'}} />
                            <h3 style={{paddingLeft: '10px'}}>Mirror <Arrow /></h3>
                            </div>
                            <p className='textWreck'>Collect NFTs of Satire edition on Mirror.</p>
